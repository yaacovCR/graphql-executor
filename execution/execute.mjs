...
export async function executeSubscription(exeContext) {
...
export async function createSourceEventStreamImpl(exeContext) {
  try {
...
async function executeSubscriptionRootField(exeContext) {
